        ...
        <div className="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
          <div className="col-span-12 lg:col-span-6 mb-[30px]">
            <h2 className="font-recoleta text-primary text-[24px] sm:text-[30px] leading-[1.277] xl:text-xl mb-[15px]">
              Login to Bary<span className="text-secondary">.</span></h2>
              ...
              <div className="col-span-12">
                ...
                <div className="flex flex-wrap items-center justify-between w-full sm:w-[400px] mt-[15px]">
                  <div className="flex flex-wrap items-center">
                    ...
                    <label htmlFor="checkbox1" className="ml-[5px] cursor-pointer text-[14px]"> Remember
                      me</label><br />
                  </div>
                  <a href="#" className="hover:text-secondary text-[14px] block">Forgot Password</a>
                </div>
              </div>
              <div className="col-span-12">
                <div className="flex flex-wrap items-center">
                  ...
                  <a href="register.html" className="font-medium text-primary hover:text-secondary ml-[40px]">Register</a>
                </div>
              </div>
            </div>
          </div>
          <div className="col-span-12 lg:col-span-6 mb-[30px]">
            <img src="/images/contact/image.png" className="w-full h-auto rounded-[10px]" width={546} height={478} alt="image" />
          </div>
        </div>
      </form>
    </div>
