...
function TestimonialCarousal() {
  return (
    <div>
      ...
      <section
        className="testimonial-section pt-[50px] bg-no-repeat bg-white relative z-10"
        style={{
          backgroundImage: "url(/images/testimonial/pattern.png)",
        }}
      >
                  ...
                  <div className="swiper-slide">
                    <div className="relative text-right">
                      ...
                      <div className="inline-block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-primary text-primary before:w-full before:h-[calc(100%_-_50px)] before:z-[-1] before:rounded-[16px]">
                        <img
                          src="/images/testimonial/person1.png"
