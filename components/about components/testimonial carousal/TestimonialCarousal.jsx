...
function TestimonialCarousal() {
  return (
    <div>
      ...
      <section className="testimonial-section bg-white relative z-10 py-[80px] lg:py-[120px]">
          ...
          <div className="grid items-center grid-cols-12 gap-x-[30px] mb-[-30px]">
            <div className="col-span-12 lg:col-span-4 mb-[30px]">
              <div className="relative">
                ...
                <h2 className="font-recoleta text-primary text-[24px] sm:text-[30px] xl:text-xl mb-[20px] max-w-[375px]">
            ...
            <div className="col-span-12 lg:col-span-8 mb-[30px] xl:pl-[35px]">
              <div className="swiper -m-[25px] p-[25px]">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <div className="relative">
                      ...
                      <div className="inline-block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-primary text-primary before:w-full before:h-[calc(100%_-_50px)] before:z-[-1] before:rounded-[16px]">
                        <img
                          src="/images/testimonial/person1.2.png"
                        ...
                        />
                        <img
                          className="absolute left-[20px] bottom-0 z-[1]"
                      ...
                      {/* content */}
                      <div className="review-shadow-card2 text-left rounded-[14px] pl-[20px] sm:pl-[30px] pr-[45px] pt-[30px] sm:pt-[45px] pb-[20px] sm:pb-[30px]">
                  ...
                  <div className="swiper-slide">
                    <div className="relative">
                      ...
                      <div className="inline-block relative before:absolute before:content-[''] before:inset-x-0 before:bottom-0 before:bg-primary text-primary before:w-full before:h-[calc(100%_-_50px)] before:z-[-1] before:rounded-[16px]">
                        <img
                          src="/images/testimonial/person3.png"
                          className="w-auto h-auto block mx-auto relative z-[2]"
                          loading="lazy"
                          width={300}
                          height={380}
